...
public class BarraUtente extends JPanel
{
    ...
    private JButton gestioneUtenzeButton; // Solo admin!
    ...
    public BarraUtente(Utente utente, AreaUtenteController controller)
    {
        ...
        if (utente.getAdminStatus()) {
            gestioneUtenzeButton = ModernButton.createNavbarButton("Gestione Utenze");
            gestioneUtenzeButton.setPreferredSize(new Dimension(160, 30));
        }
    ...
    private void addGestioneUtenzeEvent() {
        //da impl
