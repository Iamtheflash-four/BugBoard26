...
//    	Object[] row = createRow("Progetto" Alpha", "Alta", "Bug" ); 
    	issueTable.addRow(createRow(new IssueDTO(1,"dsad", "ada", "adad", "sfsfsdfsdfsd", "adasd", new Date() )));
    	issueTable.addRow(new Object[] { "Progetto Beta", "Media", "Richiesta" });
    	try {
    ...
    private void caricaIssueInviate() {
    	issueTable.addRow(new Object[] { "Progetto Gamma", "" ,"Bassa", "Suggerimento" });
    	issueTable.addRow(new Object[] { "Progetto Delta", "Alta", "Bug" });
    }
}
